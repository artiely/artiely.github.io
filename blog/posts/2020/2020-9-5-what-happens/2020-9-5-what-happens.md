...
tag:
  - javaScript
cover: /2022-05-13-13-27-34.png
base64: f2f2f2
author: artiely
date: 2020-9-5
tinyCover: /cover/2022-05-13-13-27-34.png
coverWidth: 564
coverHeight: 705
coverPrimary: 1d2122
coverSecondary: e2dedd
...
1. _`Creative Commons Zero`: <https://creativecommons.org/publicdomain/zero/1.0/>
1. _`CSS词法和句法`: <http://www.w3.org/TR/CSS2/grammar.html>
1. _`Punycode`: <https://en.wikipedia.org/wiki/Punycode>
1. _`以太网`: <http://en.wikipedia.org/wiki/IEEE_802.3>
1. _`WiFi`: <https://en.wikipedia.org/wiki/IEEE_802.11>
1. _`蜂窝数据网络`: <https://en.wikipedia.org/wiki/Cellular_data_communication_protocol>
1. _`analog-to-digital converter`: <https://en.wikipedia.org/wiki/Analog-to-digital_converter>
1. _`网络节点`: <https://en.wikipedia.org/wiki/Computer_network#Network_nodes>
1. _`不同的操作系统有所不同` : <https://en.wikipedia.org/wiki/Hosts>_%28file%29#Location_in_the_file_system
1. _`downgrade attack`: <http://en.wikipedia.org/wiki/SSL_stripping>
1. _`OSI 模型`: <https://en.wikipedia.org/wiki/OSI_model>
1. _`原仓库`: <https://github.com/alex/what-happens-when>
